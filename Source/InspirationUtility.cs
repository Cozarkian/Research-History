...
namespace QualityEverything
{
    ...
    class InspirationUtility
    {
        public static float Postfix(float __result, InspirationWorker __instance)
        {
            ...
            if (inspiration == DefOf_QEverything.QF_Inspired_Butchering)
            {
            ...
            if (inspiration == DefOf_QEverything.QF_Inspired_Gathering)
            {
            ...
            if (inspiration == DefOf_QEverything.QF_Inspired_Harvesting)
            {
            ...
            if (inspiration == DefOf_QEverything.QF_Inspired_Mining)
            {
            ...
            if (inspiration == DefOf_QEverything.QF_Inspired_Stonecutting)
            { 
            ...
            if (inspiration == DefOf_QEverything.QF_Inspired_Chemistry)
            {
            ...
            if (inspiration == DefOf_QEverything.QF_Inspired_Construction)
            {
            ...
            if (inspiration == DefOf_QEverything.QF_Inspired_Cooking)
            {
        ...
        public static InspirationDef CheckInspired(ThingDef thingDef, SkillDef relevantSkill)
        {
            ...
            if (relevantSkill == SkillDefOf.Construction)
            {
                ...
                else return DefOf_QEverything.QF_Inspired_Construction;
            }
            ...
            {
                if (thingDef.IsDrug || thingDef.IsMedicine) return DefOf_QEverything.QF_Inspired_Chemistry;
                if (thingDef.thingCategories.Contains(ThingCategoryDefOf.StoneBlocks)) return DefOf_QEverything.QF_Inspired_Stonecutting;
            }
            else if (relevantSkill == SkillDefOf.Cooking)
            {
                if (thingDef.thingCategories.Contains(ThingCategoryDefOf.FoodMeals)) return DefOf_QEverything.QF_Inspired_Cooking;
                else if (thingDef.IsMeat || thingDef.IsStuff) return DefOf_QEverything.QF_Inspired_Butchering;
            }
            else if (relevantSkill == SkillDefOf.Animals) return DefOf_QEverything.QF_Inspired_Gathering;
            else if (relevantSkill == SkillDefOf.Plants) return DefOf_QEverything.QF_Inspired_Harvesting;
            else if (relevantSkill == SkillDefOf.Mining) return DefOf_QEverything.QF_Inspired_Mining;
            return null;
        }
    }
}
